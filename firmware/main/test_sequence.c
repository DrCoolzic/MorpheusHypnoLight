...
void build_demo_sequence(sequence_step_t *steps) {
  ...
  /* Step 0 */
  {
    ...
    steps[step].duration_ms = 3000U;
    {
      ...
      steps[step].oscillators[osc].brightness_modulator.linear_config.end_value = 1.0f;
      steps[step].oscillators[osc].brightness_modulator.linear_config.duration_ms = 3000U;
